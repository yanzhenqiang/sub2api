...
func setDefaults() {
	...
	viper.SetDefault("pricing.remote_url", "/model-price-repo/main/model_prices_and_context_window.json")
	viper.SetDefault("pricing.hash_url", "/model-price-repo/main/model_prices_and_context_window.sha256")
